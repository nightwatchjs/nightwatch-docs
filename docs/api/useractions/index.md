...
<div class="apimethod">
  <h3>.dragAndDrop(<code>from</code>, <code>to</code>)</h3>
...
<div class="apimethod">
  <h3>.insert(<code>device</code>, <code>...actions</code>)</h3>
  <div>
...
<div class="apimethod">
  <h3>.pause(<code>duration</code>, <code>...devices</code>)</h3>
...
<div class="apimethod">
  <h3>.release(<code>[button]</code>)</h3>
...
<div class="apimethod">
  <h3>.synchronize(<code>...devices</code>)</h3>
...
<pre class="line-numbers" data-language="javascript"><code class="language-javascript">describe('example with user actions api', function () {
  <br>
