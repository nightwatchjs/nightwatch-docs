### Testing on Mobile Devices using Appium
...
<div class="sample-test"><pre class="hide-indicator language-javascript"><code>appium_ios: {
  selenium: {
    host: 'localhost',
    port: 4723
  },
...
<div class="sample-test"><pre class="language-javascript"><code>describe('Nightwatch Website tests', function() {
  <br>
...
<div class="sample-test"><pre class="language-javascript"><code>describe('W3C Actions API', function() {
